...
def competence():
    # file_path_comp = os.sep * 2 + os.path.join("tg-storage01", "Аналитический отдел", "Личные", "Федорова",
    #                                               "Служба персонала", "Действующие сотрудники", "Компетенции",
    ...
    for column in ['B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J', 'K',  'M', 'Q', 'R', 'T', 'O', 'P']:
